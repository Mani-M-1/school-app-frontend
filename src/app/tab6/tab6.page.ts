...
//this function is duplicate function ...and aslo declare in blogPost function....
  blogPosta(){
   this.http.get(`http://localhost:3000/blog/`).subscribe((data:any) => {    // after posting data from createblog page i'm getting data here.
  ...
  getBlogs(){
    this.http.get(`http://localhost:3000/blog/${this.username}`).subscribe((data:any) => {    // after posting data from createblog page i'm getting data here.
     console.log(data);    // and setting item in local storage, you can find it below of this file as setItem
    //  console.log(this.username);
     this.userBlogs = data;
