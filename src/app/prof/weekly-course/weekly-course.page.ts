...
const postdata = { 
  ...
  this.http.post("https://student-api-10-fbf8bbebe705.herokuapp.com/weeklyCourse", postdata)
  .subscribe(response => {
    ...
    console.log(error);
    this.toastService.presentToast('Some thing went wrong please check all details')
  })
